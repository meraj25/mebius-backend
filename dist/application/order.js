...
var Address_1 = __importDefault(require("../infrastructure/db/entities/Address"));
...
var createOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var data, userId, address, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Address_1.default.create(data.shippingAddress)];
            case 1:
                address = _a.sent();
